...
# création de la class pour les questions du test
class Question:
     def __init__(self, prompt):
          self.prompt = prompt
          #self.answer = answer

# écriture des questions du test
question_prompts = [
...
# écriture des retours en fonction du résultat au test
Interpretation = [
...
# fonction qui permet d'appeler mes questions dans ma class
questions = [
...
# fonction qui permet de faire marcher le code grâce à l'appel des fonctions précédement écrites
